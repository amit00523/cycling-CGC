...
<html lang="en">
  <head>
    ...
    <title>cycle good cafe project</title>
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">C.G.C</a>
        </div>
           ...
           <!--  <li><a href="category.php">Category</a></li> -->
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="conttacts.php">Contacts</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
  ...
  <div class="container">
    <h1>Welcome to Cycling Goods Cafe</h1>
